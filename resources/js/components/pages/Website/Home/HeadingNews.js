                ...
                <section className="heading-news">
                    <div className="iso-call heading-news-box">
                        ...
                        <div className="news-post image-post default-size">
                            <LazyLoadImage src="images/pemerintah/POSTER BARU PARIWISATA-01.jpg" alt="" />
                        ...
                        <div class="news-post image-post">
                            <LazyLoadImage src="images/pemerintah/POSTER BARU PARIWISATA-05.jpg" alt="" />
                            <div class="hover-box">
                                <div class="inner-hover">
                                    <a class="category-post food" href="food.html">food &amp; Health</a>
                                    <h2><a href={'/image'}>Nullam malesuada erat ut turpis.</a></h2>
                                    <ul class="post-tags">
                        ...
                        <div class="news-post image-post">
                            <LazyLoadImage src="images/pemerintah/POSTER BARU PARIWISATA-06.jpg" alt="" />
                            <div class="hover-box">
                                <div class="inner-hover">
                        ...
                        <div class="news-post image-post">
                            <LazyLoadImage src="images/pemerintah/POSTER BARU PARIWISATA-07.jpg" alt="" />
                            <div class="hover-box">
                                <div class="inner-hover">
                        ...
                        <div class="news-post image-post">
                            <LazyLoadImage src="images/pemerintah/POSTER BARU PARIWISATA-08.jpg" alt="" />
                            <div class="hover-box">
                                <div class="inner-hover">
                                    <a class="category-post fashion" href="fashion.html">fashion</a>
                                    <h2><a href={'/image'}>Quisque volutpat mattis </a></h2>
                                    <ul class="post-tags">
                                        <li><i class="fa fa-clock-o"></i><span>27 may 2013</span></li>
                                        <li><a href="#"><i class="fa fa-comments-o"></i><span>23</span></a></li>
                                    </ul>
                        ...
                        <div class="news-post image-post">
                            <LazyLoadImage src="images/pemerintah/POSTER BARU PARIWISATA-09.jpg" alt="" />
                            <div class="hover-box">
                                <div class="inner-hover">
                                    <a class="category-post sport" href="sport.html">sport</a>
                                    <h2><a href={'/image'}>Donec odio. </a></h2>
                        ...
                        <div class="news-post image-post">
                            <LazyLoadImage src="images/pemerintah/POSTER BARU PARIWISATA-10.jpg" alt="" />
                            <div class="hover-box">
                                <div class="inner-hover">
                                    <a class="category-post fashion" href="fashion.html">fashion</a>
                                    <h2><a href={'/image'}>Quisque volutpat mattis </a></h2>
                        ...
                        <div class="news-post image-post">
                            <LazyLoadImage src="images/pemerintah/POSTER BARU PARIWISATA-11.jpg" alt="" />
                            <div class="hover-box">
                                <div class="inner-hover">
                                    <a class="category-post food" href="food.html">food &amp; Health</a>
                                    <h2><a href={'/image'}>Nullam malesuada erat ut turpis.</a></h2>
