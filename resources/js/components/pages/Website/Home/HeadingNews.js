            ...
            <div>
                <section className="heading-news">
                    <div className="iso-call heading-news-box">
                                    ...
                                    <div class="news-post image-post">
                                        ...
                                        <div class="hover-box">
                                            <div class="inner-hover">
                                                ...
                                                <h2><a href={'/image'}>Phasellus ultrices nulla quis nibh. Quisque a lectus. </a></h2>
                                                <ul class="post-tags">
                                                    <li><i class="fa fa-clock-o"></i>27 may 2013</li>
                                                    <li><i class="fa fa-user"></i>by <a href="#">John Doe</a></li>
                                                    <li><a href="#"><i class="fa fa-comments-o"></i><span>23</span></a></li>
                                ...
                                <li>
                                    <div class="news-post image-post">
                                        ...
                                        <div class="hover-box">
                                            <div class="inner-hover">
                                                <a class="category-post sport" href="sport.html">sport</a>
                                                <h2><a href={'/image'}>Donec odio. Quisque volutpat mattis eros. </a></h2>
                                                <ul class="post-tags">
                                                    <li><i class="fa fa-clock-o"></i>27 may 2013</li>
                                                    <li><i class="fa fa-user"></i>by <a href="#">John Doe</a></li>
                                                    <li><a href="#"><i class="fa fa-comments-o"></i><span>23</span></a></li>
                        ...
                        <div class="news-post image-post">
                            <img src="images/pemerintah/POSTER BARU PARIWISATA-11.jpg" alt="" />
                            <div class="hover-box">
                                <div class="inner-hover">
                                    <a class="category-post food" href="food.html">food &amp; Health</a>
                                    <h2><a href={'/image'}>Nullam malesuada erat ut turpis.</a></h2>
