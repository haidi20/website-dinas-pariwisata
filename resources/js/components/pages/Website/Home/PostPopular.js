...
class PostPopular extends Component {
    render(){
        return(
            <div>
                        ...
                        <div class="features-today-box owl-wrapper">
                            <div class="owl-carousel" data-num="4">
                                ...
                                <div class="item news-post standard-post">
                                    ...
                                    <div class="post-content">
                                        <h2><a href="#">Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.</a></h2>
                                        <ul class="post-tags">
                                            <li><i class="fa fa-clock-o"></i>27 may 2013</li>
                                            <li><i class="fa fa-user"></i>by <a href="#">John Doe</a></li>
                                            <li><a href="#"><i class="fa fa-comments-o"></i><span>23</span></a></li>
                                ...
                                <div class="item news-post standard-post">
                                    ...
                                    <div class="post-content">
                                        <h2><a href="#">Aliquam porttitor mauris sit amet orci. Aenean dignissim pellentesque felis.</a></h2>
                                        <ul class="post-tags">
                                            <li><i class="fa fa-clock-o"></i>27 may 2013</li>
                                            <li><i class="fa fa-user"></i>by <a href="#">John Doe</a></li>
                                            <li><a href="#"><i class="fa fa-comments-o"></i><span>23</span></a></li>
                                ...
                                <div class="item news-post standard-post">
                                    ...
                                    <div class="post-content">
                                        <h2><a href="#">Pellentesque odio nisi, euismod in, pharetra a, ultricies in, diam. Sed arcu. </a></h2>
                                        <ul class="post-tags">
                                            <li><i class="fa fa-clock-o"></i>27 may 2013</li>
                                            <li><i class="fa fa-user"></i>by <a href="#">John Doe</a></li>
                                            <li><a href="#"><i class="fa fa-comments-o"></i><span>23</span></a></li>
