...
export default class EditVideo extends Component {
    ...
    async getData(){
        const result = await axios.get(`${baseURL}/videos/${this.props.match.params.id}`)
                ...
                <div className="static-content">
                    <div className="page-content">
                        ...
                        <ol className="breadcrumb">
                            ...
                            <li>
                                <Link to={`/sitemanager/videos/${this.props.match.params.id}`}>Edit</Link>
                            </li>
                        </ol>
